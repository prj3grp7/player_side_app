// ======================================================================
// CupSensor_IF.v generated from TopDesign.cysch
// 12/11/2018 at 12:55
...
module ADC_DelSig_v3_30_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("167cc4f3-f86d-4c62-972d-67d9c7e9a464/7ca9fb2d-b1a1-4f4a-b925-fdaea437c03f/20681f4c-d171-47ae-a1cb-d832cd711191"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    CupSensor_3 CupSensor (
        .photodiodesIn(Net_22),
        .debugOut(Net_23),
        .ledControl0(Net_24),
        .ledControl1(Net_56),
        .ledControl2(Net_61),
	...
	cy_psoc3_pins_v1_10
		...
		leds
		 (.oe(tmpOE__leds_net),
		  .y({Net_64, Net_63, Net_62, Net_61, Net_56, Net_24}),
	...
	cy_psoc3_pins_v1_10
		#(.id("2de7b257-55e6-4717-8546-160b1a63efff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dc314d08-abd1-4685-83fd-6fca5495388b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c3fb9666-1a86-4c9c-aca1-a32cfcd3b76d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
