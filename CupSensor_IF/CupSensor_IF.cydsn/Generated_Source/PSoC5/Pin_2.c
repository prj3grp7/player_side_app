...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void Pin_2_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & Pin_2_1_INTR) != 0u) 
		{ 
			 Pin_2_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_2_2_INTR) != 0u) 
		{ 
			 Pin_2_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_2_3_INTR) != 0u) 
		{ 
			 Pin_2_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_2_4_INTR) != 0u) 
		{ 
			 Pin_2_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_2_5_INTR) != 0u) 
		{ 
			 Pin_2_5_INTTYPE_REG = (uint8)mode; 
		}
    }
