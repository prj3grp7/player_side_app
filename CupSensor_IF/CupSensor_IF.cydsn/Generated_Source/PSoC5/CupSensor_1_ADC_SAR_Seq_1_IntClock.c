/*******************************************************************************
* File Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock.c
* Version 2.20
*
*  Description:
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_Start
********************************************************************************
*
* Summary:
...
void ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_Start(void) 
{
    ...
    ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN |= ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN_MASK;
	``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKSTBY |= ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_Stop
********************************************************************************
*
* Summary:
...
void ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_Stop(void) 
{
    ...
    ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN &= (uint8)(~``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN_MASK);
	``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKSTBY &= (uint8)(~``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN & ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetSourceRegister();
    uint16 oldDivider = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN & ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_DIV_PTR, clkDivider);
                ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_DIV_PTR, clkDivider);
				``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_DIV_PTR);
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC |= modeBitMask & (uint8)``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MODE_MASK;
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MODE_MASK));
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC & (uint8)(``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MODE_MASK);
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetDividerRegister();
    uint8 oldSrc = ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC |= CYCLK_SSS;
        ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC =
            (``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC & (uint8)(~``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_MOD_SRC & ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_PHASE = clkPhase & ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_GetPhase
********************************************************************************
*
* Summary:
...
{
    return ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_PHASE & ``$INSTANCE_NAME`_ADC_SAR_Seq_1_IntClock_PHASE_MASK;
}
