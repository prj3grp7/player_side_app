...
/* Interrupt Registers */
	...
	#define Pin_2_1_INTTYPE_REG 		(* (reg8 *) Pin_2__1__INTTYPE)
	#define Pin_2_2_INTTYPE_REG 		(* (reg8 *) Pin_2__2__INTTYPE)
	#define Pin_2_3_INTTYPE_REG 		(* (reg8 *) Pin_2__3__INTTYPE)
	#define Pin_2_4_INTTYPE_REG 		(* (reg8 *) Pin_2__4__INTTYPE)
	#define Pin_2_5_INTTYPE_REG 		(* (reg8 *) Pin_2__5__INTTYPE)
#endif /* (Pin_2__INTSTAT) */
