/*******************************************************************************
* File Name: ``$INSTANCE_NAME`_Clock_3.c
* Version 2.20
*
*  Description:
...
#include "``$INSTANCE_NAME`_Clock_3.h"
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_Start(void) 
{
    /* Set the bit to enable the clock. */
    ``$INSTANCE_NAME`_Clock_3_CLKEN |= ``$INSTANCE_NAME`_Clock_3_CLKEN_MASK;
	``$INSTANCE_NAME`_Clock_3_CLKSTBY |= ``$INSTANCE_NAME`_Clock_3_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    ``$INSTANCE_NAME`_Clock_3_CLKEN &= (uint8)(~``$INSTANCE_NAME`_Clock_3_CLKEN_MASK);
	``$INSTANCE_NAME`_Clock_3_CLKSTBY &= (uint8)(~``$INSTANCE_NAME`_Clock_3_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_StopBlock(void) 
{
    if ((``$INSTANCE_NAME`_Clock_3_CLKEN & ``$INSTANCE_NAME`_Clock_3_CLKEN_MASK) != 0u)
    {
...
#if defined(``$INSTANCE_NAME`_Clock_3__CFG3)
        CLK_DIST_AMASK = ``$INSTANCE_NAME`_Clock_3_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ``$INSTANCE_NAME`_Clock_3_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* ``$INSTANCE_NAME`_Clock_3__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(``$INSTANCE_NAME`_Clock_3_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(``$INSTANCE_NAME`_Clock_3_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        ``$INSTANCE_NAME`_Clock_3_CLKSTBY &= (uint8)(~``$INSTANCE_NAME`_Clock_3_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = ``$INSTANCE_NAME`_Clock_3_GetSourceRegister();
    uint16 oldDivider = ``$INSTANCE_NAME`_Clock_3_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ``$INSTANCE_NAME`_Clock_3_CLKEN & ``$INSTANCE_NAME`_Clock_3_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(``$INSTANCE_NAME`_Clock_3_DIV_PTR, clkDivider);
                ``$INSTANCE_NAME`_Clock_3_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                ``$INSTANCE_NAME`_Clock_3_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(``$INSTANCE_NAME`_Clock_3_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((``$INSTANCE_NAME`_Clock_3_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(``$INSTANCE_NAME`_Clock_3_DIV_PTR, clkDivider);
				``$INSTANCE_NAME`_Clock_3_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 ``$INSTANCE_NAME`_Clock_3_GetDividerRegister(void) 
{
    return CY_GET_REG16(``$INSTANCE_NAME`_Clock_3_DIV_PTR);
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_SetModeRegister(uint8 modeBitMask) 
{
    ``$INSTANCE_NAME`_Clock_3_MOD_SRC |= modeBitMask & (uint8)``$INSTANCE_NAME`_Clock_3_MODE_MASK;
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_ClearModeRegister(uint8 modeBitMask) 
{
    ``$INSTANCE_NAME`_Clock_3_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(``$INSTANCE_NAME`_Clock_3_MODE_MASK));
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ``$INSTANCE_NAME`_Clock_3_GetModeRegister(void) 
{
    return ``$INSTANCE_NAME`_Clock_3_MOD_SRC & (uint8)(``$INSTANCE_NAME`_Clock_3_MODE_MASK);
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = ``$INSTANCE_NAME`_Clock_3_GetDividerRegister();
    uint8 oldSrc = ``$INSTANCE_NAME`_Clock_3_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        ``$INSTANCE_NAME`_Clock_3_MOD_SRC |= CYCLK_SSS;
        ``$INSTANCE_NAME`_Clock_3_MOD_SRC =
            (``$INSTANCE_NAME`_Clock_3_MOD_SRC & (uint8)(~``$INSTANCE_NAME`_Clock_3_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ``$INSTANCE_NAME`_Clock_3_GetSourceRegister(void) 
{
    return ``$INSTANCE_NAME`_Clock_3_MOD_SRC & ``$INSTANCE_NAME`_Clock_3_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ``$INSTANCE_NAME`_Clock_3_SetPhaseRegister(uint8 clkPhase) 
{
    ``$INSTANCE_NAME`_Clock_3_PHASE = clkPhase & ``$INSTANCE_NAME`_Clock_3_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ``$INSTANCE_NAME`_Clock_3_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ``$INSTANCE_NAME`_Clock_3_GetPhaseRegister(void) 
{
    return ``$INSTANCE_NAME`_Clock_3_PHASE & ``$INSTANCE_NAME`_Clock_3_PHASE_MASK;
}
