...
volatile uint16  EZI2C_1_rwOffsetS1; /* Current offset within buffer 1 */
volatile uint16  EZI2C_1_rwIndexS1;  /* Current index within buffer 1 */
...
/* Secondary slave address variables */
    ...
    volatile uint16 EZI2C_1_rwOffsetS2; /* Current offset within buffer 2 */
    volatile uint16 EZI2C_1_rwIndexS2;  /* Current index within buffer 2 */
