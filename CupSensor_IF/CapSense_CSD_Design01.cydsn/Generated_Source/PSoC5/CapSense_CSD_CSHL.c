...
uint8 CapSense_CSD_sensorSignal[CapSense_CSD_TOTAL_SENSOR_COUNT];
...
uint8 CapSense_CSD_fingerThreshold[] = {
    125u, 
};

uint8 CapSense_CSD_noiseThreshold[] = {
    45u, 
};

uint8 CapSense_CSD_hysteresis[] = {
    25u, 
};
