// ======================================================================
// OpticSensorMixer.v generated from TopDesign.cysch
<<<<<<< HEAD
// 11/03/2018 at 16:58
=======
// 10/31/2018 at 22:20
...
=======
// TIA_v2_0(Capacitive_Feedback=3, Fcorner=69 kHz, Power=3, Resistive_Feedback=6, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TIA_v2_0, CY_CONFIG_TITLE=TIA_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIA_1, CY_INSTANCE_SHORT_NAME=TIA_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=TIA_1, )
>>>>>>> fix
module TIA_v2_0_0 (
    Iin,
    Vref,
...
// Mixer_v2_0(LO_clock_freq=4000, LO_Source=1, Mixer_Type=1, Power=2, Signal_Frequency=3500, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Mixer_v2_0, CY_CONFIG_TITLE=Mixer_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Mixer_1, CY_INSTANCE_SHORT_NAME=Mixer_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Mixer_1, )
module Mixer_v2_0_1 (
    Fin,
    Fout,
    LO,
...
module ADC_DelSig_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("7ca9fb2d-b1a1-4f4a-b925-fdaea437c03f/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("7ca9fb2d-b1a1-4f4a-b925-fdaea437c03f/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("6250000000"),
		  .is_direct(0),
...
>>>>>>> fix
	...
	wire [0:0] tmpOE__PhotoIn_net;
	wire [0:0] tmpFB_0__PhotoIn_net;
	wire [0:0] tmpIO_0__PhotoIn_net;
	wire [0:0] tmpINTERRUPT_0__PhotoIn_net;
	electrical [0:0] tmpSIOVREF__PhotoIn_net;
	...
	cy_psoc3_pins_v1_10
		...
		PhotoIn
		 (.oe(tmpOE__PhotoIn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PhotoIn_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__PhotoIn_net[0:0]}),
		  .siovref(tmpSIOVREF__PhotoIn_net),
		  .interrupt({tmpINTERRUPT_0__PhotoIn_net[0:0]}),
		  .annotation({Net_30}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PhotoIn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam D_3.comp_name = "PhotoDiode_v1_0";
...
>>>>>>> fix
	...
	wire [0:0] tmpOE__ExtClock_net;
	wire [0:0] tmpFB_0__ExtClock_net;
	wire [0:0] tmpIO_0__ExtClock_net;
	wire [0:0] tmpINTERRUPT_0__ExtClock_net;
	electrical [0:0] tmpSIOVREF__ExtClock_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ExtClock
		 (.oe(tmpOE__ExtClock_net),
		  .y({Net_754}),
		  .fb({tmpFB_0__ExtClock_net[0:0]}),
		  .io({tmpIO_0__ExtClock_net[0:0]}),
		  .siovref(tmpSIOVREF__ExtClock_net),
		  .interrupt({tmpINTERRUPT_0__ExtClock_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ExtClock_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
>>>>>>> fix
	...
	cy_clock_v1_0
		#(.id("139349ad-034b-4c4b-b529-cc0b8b2a532b"),
		  .source_clock_id(""),
		  .divisor(0),
<<<<<<< HEAD
		  .period("15151515151.5152"),
=======
		  .period("250000000000"),
>>>>>>> fix
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7ccb60c6-1c2b-4cdc-ab9c-0a22f447a760"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_6 UART (
        ...
        .reset(Net_808),
        .rx(Net_809),
        .tx_interrupt(Net_810),
        .rx_interrupt(Net_811),
        .tx_data(Net_812),
        .tx_clk(Net_813),
        .rx_data(Net_814),
        .rx_clk(Net_815));
