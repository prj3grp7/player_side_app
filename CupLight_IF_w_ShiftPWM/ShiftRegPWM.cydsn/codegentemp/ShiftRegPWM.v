// ======================================================================
// ShiftRegPWM.v generated from TopDesign.cysch
// 11/26/2018 at 13:16
...
module top ;
    ...
    SPI_Master_v2_50_1 SPIM_led_control (
        .mosi(Net_1225),
        .sclk(Net_1226),
        .ss(Net_1438),
        .miso(Net_1228),
    ...
    Timer_v2_80_2 Timer_led_updater (
        .reset(Net_12),
        .interrupt(Net_1409),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1480),
        .tc(Net_1481),
        .clock(Net_10));
	...
	wire [0:0] tmpOE__Pin_update_time_net;
	wire [0:0] tmpFB_0__Pin_update_time_net;
	wire [0:0] tmpIO_0__Pin_update_time_net;
	wire [0:0] tmpINTERRUPT_0__Pin_update_time_net;
	electrical [0:0] tmpSIOVREF__Pin_update_time_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_update_time
		 (.oe(tmpOE__Pin_update_time_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_update_time_net[0:0]}),
		  .io({tmpIO_0__Pin_update_time_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_update_time_net),
		  .interrupt({tmpINTERRUPT_0__Pin_update_time_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_update_time_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
