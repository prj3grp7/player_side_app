// ======================================================================
// integration_all.v generated from TopDesign.cysch
// 01/20/2019 at 13:56
...
// OpAmp_v1_90(Mode=1, Power=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CupSensor:Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CupSensor_Opamp_1, )
...
// TIA_v2_0(Capacitive_Feedback=3, Fcorner=397 kHz, Power=3, Resistive_Feedback=3, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TIA_v2_0, CY_CONFIG_TITLE=TIA, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CupSensor:TIA, CY_INSTANCE_SHORT_NAME=TIA, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CupSensor_TIA, )
module TIA_v2_0_6 (
    Iin,
    Vref,
    Vout);
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CupSensor:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CupSensor_VDAC8, )
...
// ADC_DelSig_v3_30(ADC_Alignment=2, ADC_Alignment_Config2=0, ADC_Alignment_Config3=0, ADC_Alignment_Config4=0, ADC_Charge_Pump_Clock=true, ADC_Clock=1, ADC_CLOCK_FREQUENCY=160000, ADC_Input_Mode=0, ADC_Input_Range=5, ADC_Input_Range_Config2=4, ADC_Input_Range_Config3=4, ADC_Input_Range_Config4=4, ADC_Power=1, ADC_Reference=7, ADC_Reference_Config2=0, ADC_Reference_Config3=0, ADC_Reference_Config4=0, ADC_Resolution=16, ADC_Resolution_Config2=16, ADC_Resolution_Config3=16, ADC_Resolution_Config4=16, Clock_Frequency=64000, Comment_Config1=Default Config, Comment_Config2=Second Config, Comment_Config3=Third Config, Comment_Config4=Fourth Config, Config1_Name=CFG1, Config2_Name=CFG2, Config3_Name=CFG3, Config4_Name=CFG4, Configs=1, Conversion_Mode=2, Conversion_Mode_Config2=2, Conversion_Mode_Config3=2, Conversion_Mode_Config4=2, Enable_Vref_Vss=false, EnableModulatorInput=true, Input_Buffer_Gain=1, Input_Buffer_Gain_Config2=1, Input_Buffer_Gain_Config3=1, Input_Buffer_Gain_Config4=1, Input_Buffer_Mode=0, Input_Buffer_Mode_Config2=1, Input_Buffer_Mode_Config3=1, Input_Buffer_Mode_Config4=1, Ref_Voltage=1.3, Ref_Voltage_Config2=1.024, Ref_Voltage_Config3=1.024, Ref_Voltage_Config4=1.024, rm_int=false, Sample_Rate=2500, Sample_Rate_Config2=10000, Sample_Rate_Config3=10000, Sample_Rate_Config4=10000, Start_of_Conversion=0, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_DelSig_v3_30, CY_CONFIG_TITLE=ADC_DelSig, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CupSensor:ADC_DelSig, CY_INSTANCE_SHORT_NAME=ADC_DelSig, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CupSensor_ADC_DelSig, )
module ADC_DelSig_v3_30_8 (
	...
	cy_clock_v1_0
		#(.id("167cc4f3-f86d-4c62-972d-67d9c7e9a464/7ca9fb2d-b1a1-4f4a-b925-fdaea437c03f/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_psoc3_pins_v1_10
		#(.id("167cc4f3-f86d-4c62-972d-67d9c7e9a464/7ca9fb2d-b1a1-4f4a-b925-fdaea437c03f/93327f79-f616-44c2-ae10-d5db5cc52542"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("167cc4f3-f86d-4c62-972d-67d9c7e9a464/7ca9fb2d-b1a1-4f4a-b925-fdaea437c03f/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("6250000000"),
		  .is_direct(0),
...
// CupSensor(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CupSensor, CY_CONFIG_TITLE=CupSensor, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CupSensor, CY_INSTANCE_SHORT_NAME=CupSensor, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CupSensor, )
module CupSensor_9 (
    photodiodesIn,
    debugOut,
    ledControl0,
    ...
    CyControlReg_v1_80 Control_Reg_Led (
        .control_1(Net_439),
        .control_2(Net_440),
        .control_3(Net_441),
        .control_0(Net_442),
    ...
    defparam Control_Reg_Led.BusDisplay = 1;
    defparam Control_Reg_Led.ExtrReset = 0;
    defparam Control_Reg_Led.NumOutputs = 3;
    ...
    begin : demux_1
        ...
        always @(Net_292 or Net_78)
        begin
            case (Net_78[2:0])
                3'b000:
                begin
                    tmp__demux_1_0_reg = Net_292;
                ...
                begin
                    ...
                    tmp__demux_1_5_reg = 1'b0;
                    tmp__demux_1_6_reg = 1'b0;
                    tmp__demux_1_7_reg = Net_292;
                end
            endcase
        end
        assign ledControl0 = tmp__demux_1_0_reg;
        assign ledControl1 = tmp__demux_1_1_reg;
        assign ledControl2 = tmp__demux_1_2_reg;
        assign ledControl3 = tmp__demux_1_3_reg;
        assign ledControl4 = tmp__demux_1_4_reg;
        assign ledControl5 = tmp__demux_1_5_reg;
        assign Net_437 = tmp__demux_1_6_reg;
        assign Net_438 = tmp__demux_1_7_reg;
    end
    // -- De Mux end --
	...
	cy_clock_v1_0
		#(.id("167cc4f3-f86d-4c62-972d-67d9c7e9a464/139349ad-034b-4c4b-b529-cc0b8b2a532b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__photodiodes_net;
	wire [0:0] tmpFB_0__photodiodes_net;
	wire [0:0] tmpIO_0__photodiodes_net;
	wire [0:0] tmpINTERRUPT_0__photodiodes_net;
	electrical [0:0] tmpSIOVREF__photodiodes_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		photodiodes
		 (.oe(tmpOE__photodiodes_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__photodiodes_net[0:0]}),
		  .analog({Net_193}),
		  .io({tmpIO_0__photodiodes_net[0:0]}),
		  .siovref(tmpSIOVREF__photodiodes_net),
		  .interrupt({tmpINTERRUPT_0__photodiodes_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__photodiodes_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("03734e0d-f21b-42a8-ac92-f77f28736da5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [5:0] tmpOE__leds_net;
	wire [5:0] tmpFB_5__leds_net;
	wire [5:0] tmpIO_5__leds_net;
	wire [0:0] tmpINTERRUPT_0__leds_net;
	electrical [0:0] tmpSIOVREF__leds_net;

	cy_psoc3_pins_v1_10
		#(.id("e5d952cc-b68b-4cc6-a899-677b38d18cb5"),
		...
		leds
		 (.oe(tmpOE__leds_net),
		  .y({Net_197, Net_198, Net_199, Net_200, Net_201, Net_202}),
		  .fb({tmpFB_5__leds_net[5:0]}),
		  .io({tmpIO_5__leds_net[5:0]}),
	...
	assign tmpOE__leds_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

    CupSensor_9 CupSensor (
        .photodiodesIn(Net_193),
        .debugOut(Net_194),
        .ledControl0(Net_197),
        .ledControl1(Net_198),
        .ledControl2(Net_199),
	...
	wire [0:0] tmpOE__Test_time_pin_net;
	wire [0:0] tmpFB_0__Test_time_pin_net;
	wire [0:0] tmpIO_0__Test_time_pin_net;
	wire [0:0] tmpINTERRUPT_0__Test_time_pin_net;
	electrical [0:0] tmpSIOVREF__Test_time_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("50b1e504-0158-4165-84f0-5234442dd7ac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Test_time_pin
		 (.oe(tmpOE__Test_time_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Test_time_pin_net[0:0]}),
		  .io({tmpIO_0__Test_time_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Test_time_pin_net),
		  .interrupt({tmpINTERRUPT_0__Test_time_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Test_time_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("968ac033-4271-4ede-b6da-560e3277ebca"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
