// ======================================================================
// integration_controller-light.v generated from TopDesign.cysch
// 12/14/2018 at 14:59
...
module top ;
    ...
    SPI_Master_v2_50_3 SPIM_led_control (
        .mosi(Net_151),
        .sclk(Net_152),
        .ss(Net_153),
        .miso(Net_154),
        .clock(Net_1390),
        .reset(1'b0),
        .rx_interrupt(Net_156),
        .sdat(Net_157),
        .tx_interrupt(Net_158));
	...
	cy_clock_v1_0
		#(.id("2b6c1231-2387-47bb-a1fe-55c61b332ab7"),
    ...
    Timer_v2_80_4 Timer_led_updater (
        .reset(Net_162),
        .interrupt(Net_1409),
        .enable(1'b1),
        .trigger(1'b1),
    ...
    defparam Timer_led_updater.Resolution = 16;
